...
describe('Parser zero-or-more quantifier integration', () => {
    let parser: Parser;
    ...
    it('should be able to parse a regex pattern containing a zero-or-more quantifier of a single character', () => {
    ...
    it('should be able to parse a regex pattern containing a zero-or-more quantifier of a capturing group', () => {
