...
describe('Parser lookaround lookbehind integration', () => {
    let parser: Parser;
    ...
    it('should be able to parse a regex pattern containing a single positive lookbehind', () => {
    ...
    it('should be able to parse a regex pattern containing a single negative lookbehind', () => {
        const ast = parser.parse('my (?<!stuff inside) here');
    ...
    it('should be able to parse a regex pattern containing a nested lookbehind', () => {
