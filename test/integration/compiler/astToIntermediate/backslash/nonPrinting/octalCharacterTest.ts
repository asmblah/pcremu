...
describe('AST-to-IR compiler octal character escape integration', () => {
    ...
    it('should be able to compile an AST with octal char escape and two literals to IR', () => {
        ...
        ast.getPattern.returns('hello\\10world');
        ast.getFlags.returns({});
